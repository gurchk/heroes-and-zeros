...
class Bet {
    ...
    createCard() {
        ...
        shareButton.addEventListener("click", () => {
            /*
          Skapa metataggar dynamiskt. Detta kan ev användas om vi använder en node.js express prerender.

          let meta = document.createElement("meta");
          meta.setAttribute("property", "og:url");
          meta.setAttribute("content", `https://gurchk.github.io/heroes-and-zeros//?search=“${this.id}”`);
          ...
          meta.setAttribute("content", "${this.question}");
          document.getElementsByTagName("head")[0].appendChild(meta);

          meta = document.createElement("meta");
          meta.setAttribute("property", "og:image");
          meta.setAttribute("content", "https://kazzidy.wordpress.com/2011/02/06/hej/")
          document.getElementsByTagName("head")[0].appendChild(meta);
*/
            FB.ui({
                method: 'share',
